...
def calculate_difference(target_layer_files, neutral_layer_files, normalize=True):
        ...
        try:
            ...
            if normalize:
                ...
                if norm > 0:
                    ...
                    print(
                        f"Normalized {layer_name} difference, norm: {norm.item():.4f}"
                    )
...
def main():
    ...
    parser.add_argument(
        "--normalize",
        action="store_true",
        help="Apply sum of squares (L2) normalization to differences",
    )
    ...
    differences = calculate_difference(
        target_layer_files, neutral_layer_files, args.normalize
    )
